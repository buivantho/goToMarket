...
class ShipComponent extends StatefulWidget {
  final String phoneNumber;

  ShipComponent({@required this.phoneNumber});
  @override
  _ShipComponentState createState() => _ShipComponentState(phoneNumber);
  // phoneNumber
}
...
class _ShipComponentState extends State<ShipComponent> {
  var phoneNumber;

  _ShipComponentState(this.phoneNumber);
  ...
  void deliveryStatus(phoneUser) {
    ...
    FirebaseFirestore.instance
        ...
        .update({
      'status': 2,
      'user_ship': profile_user,
      "updateby": DateFormat("yyyy-MM-dd hh:mm:ss").format(DateTime.now()),
    });
    service = [];
    objIdService = [];
    getData();
