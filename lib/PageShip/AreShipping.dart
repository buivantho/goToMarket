...
class AreShipping extends StatefulWidget {
  final String phoneNumber;

  AreShipping({@required this.phoneNumber});
  @override
  _AreShippingState createState() => _AreShippingState(phoneNumber);
}
...
var timenowformat;
class _AreShippingState extends State<AreShipping> {
  var phoneNumber;

  _AreShippingState(this.phoneNumber);
  ...
  void deliveryStatus(phoneUser) {
    ...
    FirebaseFirestore.instance
        ...
        .update({'status': 3,
         'phoneUser_ship': phoneNumber.toString(),
          "delivery_time": DateFormat("yyyy-MM-dd hh:mm:ss").format(DateTime.now()),});
    service = [];
    objIdService = [];
    getData();
  }
